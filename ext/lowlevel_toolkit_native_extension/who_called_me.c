...
static VALUE who_called_me(VALUE self) { return rb_debug_inspector_open(callback, (void *) !NULL); }
static VALUE who_called_me_binding(VALUE self) { return rb_debug_inspector_open(callback, NULL); }
