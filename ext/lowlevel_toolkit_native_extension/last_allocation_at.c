...
void on_newobj_event(VALUE tpval, RB_UNUSED_VAR(void *_)) {
  if (stack == Qnil ||
...
VALUE track_last_allocation_at(RB_UNUSED_VAR(VALUE _)) {
...
VALUE last_allocation_at(RB_UNUSED_VAR(VALUE _)) {
